...
import {
  PostgresServerResourceDto, useGetApiResourcePostgresServerResourceByServerIdQuery,
...
export const PostgresServerNetworkSubpage = ({
  resourceBaseData,
}: {
  resourceBaseData: PostgresServerResourceDto;
}) => {
